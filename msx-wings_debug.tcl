...
#ram_watch   add     0xc03e      -type word      -desc Debug_Temp_Word       -format hex

ram_watch   add     0xc047      -type byte      -desc Screen_Y_Origin       -format dec

ram_watch   add     0xc01c      -type byte      -desc En0_Status            -format dec
ram_watch   add     0xc01d      -type byte      -desc En0_X            -format dec
ram_watch   add     0xc01e      -type byte      -desc En0_Y            -format dec
ram_watch   add     0xc01f      -type byte      -desc En0_Y_Static            -format dec
ram_watch   add     0xc020      -type byte      -desc En0_Y_Pat_0            -format dec
ram_watch   add     0xc021      -type byte      -desc En0_Y_Pat_1            -format dec
